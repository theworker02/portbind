...
[![npm](https://img.shields.io/npm/v/%40magnexis/portbind.svg)](https://www.npmjs.com/package/%40magnexis/portbind)

Package version **1.00** (`1.0.0`). Default branch is **`main`** — never `master`.

**Docs:** [GitHub Pages](https://theworker02.github.io/portbind/) · **Source:** [`theworker02/portbind`](https://github.com/theworker02/portbind) · **Release 1.00:** [`v1.0.0`](https://github.com/theworker02/portbind/releases/tag/v1.0.0) · **npm:** [`@magnexis/portbind`](https://www.npmjs.com/package/%40magnexis/portbind)
...
```bash
npm i -g @magnexis/portbind
portbind --help
```

Package page: https://www.npmjs.com/package/%40magnexis/portbind
